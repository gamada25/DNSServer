...
# Define salt and password
salt = os.urandom(16)  # Randomly generate a salt
...
def run_dns_server():
    ...
    server_socket.bind(('0.0.0.0', 53))  # Bind to all interfaces on standard DNS port
    ...
    while True:
        try:
            ...
            response.flags |= dns.flags.AA  # Set authoritative answer flag
